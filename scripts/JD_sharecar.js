 ...
 * @LastEditors: ZeroMah
 * @LastEditTime: 2021年1月14日11:55:37
 * 一键获取所有互助码脚本 https://raw.githubusercontent.com/lxk0301/jd_scripts/master/jd_get_share_code.js
 * 互助码填入boxjs中的订阅 https://raw.githubusercontent.com/ZeroMah/ME/main/scripts/ZeroMah.boxjs.json
*/ 
const $ = new Env("互助码");
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "e7lhibzb3zek22pimbp4ydz6ec3vedjexerujzi",
    nc: $.getdata("nc_shareCode1") || "2292cffba56f45ec8da7043bae4faa14",
    mc: $.getdata("mc_shareCode1") || "MTAxODc2NTEzMzAwMDAwMDAzMTYwOTk4Mw==",
    ddgc: $.getdata("dd_shareCode1") || "T0225KkcRBlP_VLeIk6nl_MDJgCjVWnYaS5kRrbA",
  ...
  },
  {
    ...
    nc: $.getdata("nc_shareCode2") || "bda59a266ae74150a83425af9bacc37a",
    mc: $.getdata("mc_shareCode2") || "MTE1NDUyMjEwMDAwMDAwMzUwNTI0Njc=",
    ddgc: $.getdata("dd_shareCode2") || "T01276MtEV1cmgeECjVWnYaS5kRrbA",
...
!(async () => {
  ...
  for (let i = 0; i < shareCodes.length; i++) {
    const { zd, nc, mc, ddgc, jxgc, jdzz,fg, lxj, } = shareCodes[i];
    await $.wait($.random);
    zd &&
      (await create(
    ...
    fg &&
      (await create(
        `https://code.chiang.fun/api/v1/jd/jdcash/create/${lxj}/`,
        "京东领现金"   
      ));
  }
  await showMsg();
