...
let PetShareCodes = [
  'MTAxODc2NTEzMzAwMDAwMDAzMTYwOTk4Mw==@MTE1NDUyMjEwMDAwMDAwMzUwNTI0Njc=',//账号一的好友shareCode,不同好友中间用@符号隔开
  'MTAxODc2NTEzMzAwMDAwMDAzMTYwOTk4Mw==@MTE1NDUyMjEwMDAwMDAwMzUwNTI0Njc=',//账号二的好友shareCode，不同好友中间用@符号隔开
]
